...
if($_GET['subcat']=='add-user-profile'){
   ...
   $editId= $_GET['edit'];
   $query="SELECT * FROM user_profile WHERE id=$editId";
...
?>
	...
	<div class="row">
		...
		<div class="col text-right">
			<a href="dashboard.php?cat=website-user&subcat=user-profile" class="btn btn-secondary content-link"> View</a>
		</div>
	</div>
<br>
...
<div class="row">
	...
	<div class="col text-right">
		<a href="dashboard.php?cat=website-user&subcat=user-profile" class="btn btn-secondary content-link">Back</a>
	</div>
</div>
<br>
  ...
  {$i=1;
   while($data=$res1->fetch_assoc()){
   	...
   	<tr>
   		...
   		<td><a  href="dashboard.php?cat=website-user&subcat=user-profile&view=<?php echo $data['id']; ?>" class="text-secondary content-link"><i class='far fa-eye'></i></a></td>
